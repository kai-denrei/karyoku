...
import { initPlateTab } from './plate-tab.js?v=7e146775';
import { initWorldTab } from './world-tab.js?v=7e146775';
import { initDriveTab } from './drive-tab.js?v=7e146775';
import { registerServiceWorker } from './pwa.js?v=7e146775';
import { initSoundLabTab } from './soundlab-tab.js?v=7e146775';
