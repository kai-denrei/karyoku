...
import { initPlateTab } from './plate-tab.js?v=c43c648b';
import { initWorldTab } from './world-tab.js?v=c43c648b';
import { initDriveTab } from './drive-tab.js?v=c43c648b';
import { registerServiceWorker } from './pwa.js?v=c43c648b';
import { initSoundLabTab } from './soundlab-tab.js?v=c43c648b';
