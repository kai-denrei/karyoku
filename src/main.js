...
import { initPlateTab } from './plate-tab.js?v=3e6a547f';
import { initWorldTab } from './world-tab.js?v=3e6a547f';
import { initDriveTab } from './drive-tab.js?v=3e6a547f';
import { registerServiceWorker } from './pwa.js?v=3e6a547f';
import { initSoundLabTab } from './soundlab-tab.js?v=3e6a547f';
