...
import { initPlateTab } from './plate-tab.js?v=2c3e4bb9';
import { initWorldTab } from './world-tab.js?v=2c3e4bb9';
import { initDriveTab } from './drive-tab.js?v=2c3e4bb9';
import { registerServiceWorker } from './pwa.js?v=2c3e4bb9';
import { initSoundLabTab } from './soundlab-tab.js?v=2c3e4bb9';
