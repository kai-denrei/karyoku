...
import { initPlateTab } from './plate-tab.js?v=6c60467a';
import { initWorldTab } from './world-tab.js?v=6c60467a';
import { initDriveTab } from './drive-tab.js?v=6c60467a';
import { registerServiceWorker } from './pwa.js?v=6c60467a';
import { initSoundLabTab } from './soundlab-tab.js?v=6c60467a';
