...
import { initPlateTab } from './plate-tab.js?v=71b390d7';
import { initWorldTab } from './world-tab.js?v=71b390d7';
import { initDriveTab } from './drive-tab.js?v=71b390d7';
import { registerServiceWorker } from './pwa.js?v=71b390d7';
