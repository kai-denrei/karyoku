...
import { initPlateTab } from './plate-tab.js?v=4cf41af5';
import { initWorldTab } from './world-tab.js?v=4cf41af5';
import { initDriveTab } from './drive-tab.js?v=4cf41af5';
import { registerServiceWorker } from './pwa.js?v=4cf41af5';
import { initSoundLabTab } from './soundlab-tab.js?v=4cf41af5';
