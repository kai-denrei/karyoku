...
import { initPlateTab } from './plate-tab.js?v=23bfe440';
import { initWorldTab } from './world-tab.js?v=23bfe440';
import { initDriveTab } from './drive-tab.js?v=23bfe440';
import { registerServiceWorker } from './pwa.js?v=23bfe440';
import { initSoundLabTab } from './soundlab-tab.js?v=23bfe440';
