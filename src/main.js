...
import { initPlateTab } from './plate-tab.js?v=de240947';
import { initWorldTab } from './world-tab.js?v=de240947';
import { initDriveTab } from './drive-tab.js?v=de240947';
import { registerServiceWorker } from './pwa.js?v=de240947';
import { initSoundLabTab } from './soundlab-tab.js?v=de240947';
