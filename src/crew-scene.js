...
import { loadGlbWithClips } from './glbmodels.js?v=3e6a547f';
import { CREW_KINDS, CREW_PAINT, TEAM_PAINT } from './crew.js?v=3e6a547f';
import { BZ, styleForLook } from './looks.js?v=3e6a547f';
