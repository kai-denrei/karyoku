...
import { loadGlbWithClips } from './glbmodels.js?v=4cf41af5';
import { CREW_KINDS, CREW_PAINT, TEAM_PAINT } from './crew.js?v=4cf41af5';
import { BZ, styleForLook } from './looks.js?v=4cf41af5';
