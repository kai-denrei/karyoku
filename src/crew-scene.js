...
import { loadGlbWithClips } from './glbmodels.js?v=dc8a0b52';
import { CREW_KINDS, CREW_PAINT, TEAM_PAINT } from './crew.js?v=dc8a0b52';
import { BZ, styleForLook } from './looks.js?v=dc8a0b52';
