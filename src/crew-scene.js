...
import { loadGlbWithClips } from './glbmodels.js?v=cd096da1';
import { CREW_KINDS, CREW_PAINT, TEAM_PAINT } from './crew.js?v=cd096da1';
import { BZ, styleForLook } from './looks.js?v=cd096da1';
