...
import { noteStep } from './fps.js?v=cd096da1';
import { bodyDims } from './catalog.js?v=cd096da1';
import { makePlateParams, clampPlateParams, PLATE_KNOBS, CELL_M, reservedAt } from './plate.js?v=cd096da1';
import { DRIVE_KNOBS, makeDriveParams, clampDriveParams, makeHull, stepHull, stepGates, stepSentries, stepTracers, fireHull, damageAt, autopilotInput, makeBodies, stepBodies, bodyAt, shotRangeFor, solidHeightAt, SOLID_HEIGHT, damageSentryAt, stepCrush, stepRam, ammoDotsLit, bodyHit, damageBody, powered } from './drive.js?v=cd096da1';
import { WORLD_KNOBS, makeWorldParams, clampWorldParams, makeWorld, worldBlocked, worldBuildingAt, worldLosFor, worldSentries, worldGates, terrainNormal, splitQuad, groundAt, outpostGround } from './world.js?v=cd096da1';
import { PALETTE, terrainMeshes, floraMeshes, LOOK, LOOKS } from './looks.js?v=cd096da1';
import { withParam } from './url.js?v=cd096da1';
import { buildPlateGroup, yawRotation, setGateOpen } from './plate-scene.js?v=cd096da1';
import { query, loadCatalog } from './plate-tab.js?v=cd096da1';
import { modelledIds } from './catalog.js?v=cd096da1';
import { makeViewer, makeHullObject, makeKeys, makeTracerPool, followCamera, CAMERA_KEYS, makeMobileShell, mobileShell, makeGuardObject, makeFlagStand, makeCarriedFlag } from './drive-rig.js?v=cd096da1';
import { makeSfx } from './sfx.js?v=cd096da1';
import { makeCrew, stepCrew, stepSquash, shotHits, splashHits, hullCovers, crewFreeAt, keyAreas, CREW_TUNE } from './crew.js?v=cd096da1';
import { makeCrewScene } from './crew-scene.js?v=cd096da1';
import { makeGuard, stepGuard, GUARD_TUNE } from './guard.js?v=cd096da1';
import { makeCtf, stepCtf, poleState, SLOTS, CTF_TUNE } from './ctf.js?v=cd096da1';
import { makeRescue, stepBoarding, stepUnloading, makeRescued, stepEntered, RESCUE_TUNE } from './rescue.js?v=cd096da1';
import { proto } from './plate-scene.js?v=cd096da1';
import { fileFor } from './catalog.js?v=cd096da1';
