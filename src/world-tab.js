...
import { noteStep } from './fps.js?v=5fd2b9fe';
import { bodyDims } from './catalog.js?v=5fd2b9fe';
import { makePlateParams, clampPlateParams, PLATE_KNOBS, CELL_M, reservedAt } from './plate.js?v=5fd2b9fe';
import { DRIVE_KNOBS, makeDriveParams, clampDriveParams, makeHull, stepHull, stepGates, stepSentries, stepTracers, fireHull, damageAt, autopilotInput, makeBodies, stepBodies, bodyAt, shotRangeFor, solidHeightAt, SOLID_HEIGHT, damageSentryAt, stepCrush, stepRam, ammoDotsLit, bodyHit, damageBody, powered } from './drive.js?v=5fd2b9fe';
import { WORLD_KNOBS, makeWorldParams, clampWorldParams, makeWorld, worldBlocked, worldBuildingAt, worldLosFor, worldSentries, worldGates, terrainNormal, splitQuad, groundAt, outpostGround } from './world.js?v=5fd2b9fe';
import { PALETTE, terrainMeshes, floraMeshes, LOOK, LOOKS } from './looks.js?v=5fd2b9fe';
import { withParam } from './url.js?v=5fd2b9fe';
import { buildPlateGroup, yawRotation, setGateOpen } from './plate-scene.js?v=5fd2b9fe';
import { query, loadCatalog } from './plate-tab.js?v=5fd2b9fe';
import { modelledIds } from './catalog.js?v=5fd2b9fe';
import { makeViewer, makeHullObject, makeKeys, makeTracerPool, followCamera, CAMERA_KEYS, makeMobileShell, mobileShell, makeGuardObject, makeFlagStand, makeCarriedFlag } from './drive-rig.js?v=5fd2b9fe';
import { makeSfx } from './sfx.js?v=5fd2b9fe';
import { makeCrew, stepCrew, stepSquash, shotHits, splashHits, hullCovers, crewFreeAt, keyAreas, CREW_TUNE } from './crew.js?v=5fd2b9fe';
import { makeCrewScene } from './crew-scene.js?v=5fd2b9fe';
import { makeGuard, stepGuard, GUARD_TUNE } from './guard.js?v=5fd2b9fe';
import { makeCtf, stepCtf, poleState, SLOTS, CTF_TUNE } from './ctf.js?v=5fd2b9fe';
import { makeRescue, stepBoarding, stepUnloading, makeRescued, stepEntered, RESCUE_TUNE } from './rescue.js?v=5fd2b9fe';
import { proto } from './plate-scene.js?v=5fd2b9fe';
import { fileFor } from './catalog.js?v=5fd2b9fe';
