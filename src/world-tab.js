...
import { noteStep } from './fps.js?v=eb404f6f';
import { bodyDims } from './catalog.js?v=eb404f6f';
import { makePlateParams, clampPlateParams, PLATE_KNOBS, CELL_M, reservedAt } from './plate.js?v=eb404f6f';
import { DRIVE_KNOBS, makeDriveParams, clampDriveParams, makeHull, stepHull, stepGates, stepSentries, stepTracers, fireHull, damageAt, autopilotInput, makeBodies, stepBodies, bodyAt, shotRangeFor, solidHeightAt, SOLID_HEIGHT, damageSentryAt, stepCrush, stepRam, ammoDotsLit, bodyHit, damageBody, powered } from './drive.js?v=eb404f6f';
import { WORLD_KNOBS, makeWorldParams, clampWorldParams, makeWorld, worldBlocked, worldBuildingAt, worldLosFor, worldSentries, worldGates, terrainNormal, splitQuad, groundAt, outpostGround } from './world.js?v=eb404f6f';
import { PALETTE, terrainMeshes, floraMeshes, LOOK, LOOKS } from './looks.js?v=eb404f6f';
import { withParam } from './url.js?v=eb404f6f';
import { buildPlateGroup, yawRotation, setGateOpen } from './plate-scene.js?v=eb404f6f';
import { query, loadCatalog } from './plate-tab.js?v=eb404f6f';
import { modelledIds } from './catalog.js?v=eb404f6f';
import { makeViewer, makeHullObject, makeKeys, makeTracerPool, followCamera, CAMERA_KEYS, makeMobileShell, mobileShell, makeGuardObject, makeFlagStand, makeCarriedFlag } from './drive-rig.js?v=eb404f6f';
import { makeSfx } from './sfx.js?v=eb404f6f';
import { makeCrew, stepCrew, stepSquash, shotHits, splashHits, hullCovers, crewFreeAt, keyAreas, CREW_TUNE } from './crew.js?v=eb404f6f';
import { makeCrewScene } from './crew-scene.js?v=eb404f6f';
import { makeGuard, stepGuard, GUARD_TUNE } from './guard.js?v=eb404f6f';
import { makeCtf, stepCtf, poleState, SLOTS, CTF_TUNE } from './ctf.js?v=eb404f6f';
import { makeRescue, stepBoarding, stepUnloading, makeRescued, stepEntered, RESCUE_TUNE } from './rescue.js?v=eb404f6f';
import { proto } from './plate-scene.js?v=eb404f6f';
import { fileFor } from './catalog.js?v=eb404f6f';
