...
export const ELEMENTS = [
  ...
  { id: 'sentries', label: 'Sentries', events: [
    ...
    { event: 'rotor spins up before firing', key: null, want: 'its own spin-up: the ready clip went to the guard' },
    { event: 'the reckon guard lays its red pointer on you (the lock warning)', key: 'minigun_ready', wired: true },
    { event: 'the reckon guard drops its shell', key: 'tower_aoe', wired: true },
