...
import { generateMesh, relax } from './organic-grid.js?v=c43c648b';
import { valueNoise2D } from './noise.js?v=c43c648b';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND } from './plate.js?v=c43c648b';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=c43c648b';
