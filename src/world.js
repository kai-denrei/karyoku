...
import { generateMesh, relax } from './organic-grid.js?v=9a9954fb';
import { valueNoise2D } from './noise.js?v=9a9954fb';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND } from './plate.js?v=9a9954fb';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=9a9954fb';
