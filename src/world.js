...
import { generateMesh, relax } from './organic-grid.js?v=3e6a547f';
import { valueNoise2D } from './noise.js?v=3e6a547f';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND, shuffled } from './plate.js?v=3e6a547f';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=3e6a547f';
