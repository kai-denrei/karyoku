...
import { generateMesh, relax } from './organic-grid.js?v=cd096da1';
import { valueNoise2D } from './noise.js?v=cd096da1';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND, shuffled } from './plate.js?v=cd096da1';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=cd096da1';
