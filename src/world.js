...
import { generateMesh, relax } from './organic-grid.js?v=9d12b062';
import { valueNoise2D } from './noise.js?v=9d12b062';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND } from './plate.js?v=9d12b062';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=9d12b062';
