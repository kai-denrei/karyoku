...
import { generateMesh, relax } from './organic-grid.js?v=dc8a0b52';
import { valueNoise2D } from './noise.js?v=dc8a0b52';
import { generatePlate, makePlateParams, CELL_M, DIRS, yawOfSide, KIND, shuffled } from './plate.js?v=dc8a0b52';
import { makeGates, makeSentries, blockedAt, losClear, buildingAt, gateCentre } from './drive.js?v=dc8a0b52';
