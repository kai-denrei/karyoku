...
import { makeAudio } from './audio.js?v=3e6a547f';
import { SENTRY_FIRE, DEATH_KEYS, THUD_SLICES } from './audiomanifest.js?v=3e6a547f';
import { makeImpactBurst, IMPACT_TUNE, orientImpact } from './impactfx.js?v=3e6a547f';
import { PALETTE, BZ } from './looks.js?v=3e6a547f';
import { makeTankFeel, stepTankFeel, landTankFeel, fireTankFeel, applyTankFeel } from './tankfeel.js?v=3e6a547f';
