...
import { makeAudio } from './audio.js?v=7e146775';
import { SENTRY_FIRE, DEATH_KEYS, THUD_SLICES } from './audiomanifest.js?v=7e146775';
import { makeImpactBurst, IMPACT_TUNE, orientImpact } from './impactfx.js?v=7e146775';
import { PALETTE, BZ } from './looks.js?v=7e146775';
import { makeTankFeel, stepTankFeel, landTankFeel, fireTankFeel, applyTankFeel } from './tankfeel.js?v=7e146775';
