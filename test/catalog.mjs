...
import { buildCatalog, splitId, PLACEHOLDER_HEIGHT_M, fileFor, fitFor, modelledIds, bodyDims, OUTPOST_URL, ASSEMBLY_URL, WAREHOUSE_URL, SOLAR_URL, GAME_URL } from '../src/catalog.js';
...
const cat4 = buildCatalog(CATALOG_SPEC, manifest, [{ manifest: outpost, base: OUTPOST_URL }, { manifest: assembly, base: ASSEMBLY_URL }, { manifest: warehouse, base: WAREHOUSE_URL }, { manifest: solar, base: SOLAR_URL }, { manifest: game, base: GAME_URL }]);
